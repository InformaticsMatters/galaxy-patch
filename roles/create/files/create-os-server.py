...
def create(conn,
    ...
    security_groups = [
        conn.network.find_security_group('b0b0d22d-6820-4f86-92fa-2d61b2cac958'),
        conn.network.find_security_group('55b12e1b-9ba6-4c3b-8bdf-d56a47797176'),
        conn.network.find_security_group('8c482ddf-5d5a-426e-b91c-2c8ead088431')
    ]
